...
if __name__ == '__main__':
    ...
    print(f"Without excluding timestamp, hashes are different: {hash1_no_exclude != hash2_no_exclude}")
    ...
    print(f"With timestamp excluded, hashes 1 and 3 are different: {hash1_excluded != hash3_excluded}")
