...
#define MyAppExeName "SkyLinkV0.84.exe"
...
OutputDir=.
OutputBaseFilename=SkyLink_Setup_v0.84
...
Source: "dist\SkyLinkV0.84\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
